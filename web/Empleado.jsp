<%-- 
    Document   : Empleado
    Created on : Jan 30, 2021, 9:42:48 PM
    Author     : Buddys
--%>
                    ...
                    <tbody>
                        <c:forEach var="e" items="${empleados}">
                            <tr>
                                ...
                                <td>${e.getUser()}</td>
                                <td>
                                    <a class="btn btn-warning" href="Controlador?menu=Empleado&accion=Editar&id=${e.getId()}">Editar</a>   
                                    <a class="btn btn-danger" href="Controlador?menu=Empleado&accion=Delete&id=${e.getId()}">Eliminar</a>   
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
